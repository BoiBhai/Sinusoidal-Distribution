...
\section{Analytical replication}
We want to investigate parametric limiting cases of the \sindist{} and assess the strength of such convergences. For example, it would be a task to investigate if the \sindist{} converges uniformly to the Normal, Beta, Gamma, etc. distributions in limits of its parameters. In this domain, we have discovered 1 result till now.
\subsection{Limiting Gaussianity}
...
\begin{comment}
\subsection{Limiting Gamma}
\begin{thm}
	$\Sinu(a,d,s,k)$ becomes a Gamma distribution for the parameter choice: ???
\end{thm}

\subsection{Other distributions}
What about Inverse Gamma, Beta and some other common families?
\end{comment}
