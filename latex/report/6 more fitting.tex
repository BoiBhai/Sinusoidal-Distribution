...
Higher $\alpha$: Lower rate of increase of penalization for deviating from true curve.\\
Lower $\alpha$ allows rigid maximization over the main uncontaminated curve only. However, higher $\alpha$ provides broader scope to fit over
