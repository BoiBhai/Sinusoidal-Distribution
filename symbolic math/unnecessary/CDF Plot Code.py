...
def mom(r=1, alpha=2, delta=5.5, s=1, k=3, flip=False):
    """
...
# Compute and print the 1st and 2nd moments for example parameters
print("1st moment (mean):", mom(1, 0.5, 1, s=1/3, k=1, flip=False))
print("2nd moment:", mom(2, 0.5, 1, s=1/3, k=1, flip=False))
